class Instruction {
  ...
  factory Instruction.fromJson(Map<String, dynamic> json) => Instruction(displayText: json["display_text"] != null ? json["display_text"] : '');
}
