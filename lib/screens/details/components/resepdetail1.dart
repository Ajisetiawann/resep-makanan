...
import '../../../models/resepmodel.dart';

class RecipeDetails1 extends StatelessWidget {
  final RecipeModel1 recipeModel1;
  RecipeDetails1({
    required this.recipeModel1,
  });

  get recipeModel => null;
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    recipeModel1.cookingTime.toString() + '\'',
                  ...
                  Text(
                    recipeModel1.servings.toString() + ' Servings',
                    style: TextStyle(color: Colors.black),
                  ),
                ],
              ),
          ...
          child: Stack(
            children: [
              Column(
                ...
                children: <Widget>[
                  Hero(
                    tag: recipeModel1.imgPath,
                    child: ClipRRect(
                      child: Image(
                        width: double.infinity,
                        height: (size.height / 2) + 50,
                        fit: BoxFit.cover,
                        image: AssetImage(recipeModel1.imgPath),
                      ),
                    ),
                  ),
                ],
